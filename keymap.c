...
[_QWERTY] = LAYOUT_KC(
    ...
    // +------+------+------+------+------+------+------/        \------+------+------+------+------+------+------+
                           LGUI , LALT , LOWR ,  SPC  ,              ENT   , RAIS , RALT , RGUI
    //                   +------+------+------+------/              \------+------+------+------+
),
...
[_LOWER] = LAYOUT_KC(
    ...
    // +------+------+------+------+------+------+                      +------+------+------+------+------+------+
          xx  , CIRC , AMPR , ASTR ,  xx  , LABK ,                        RABK ,  P4  ,  P5  ,  P6  , MINS , UNDS ,
    // +------+------+------+------+------+------+------+        +------+------+------+------+------+------+------+
         LCBR , BSLS , DOT  , COMM , PIPE , LBRC ,  xx  ,           xx  , RBRC ,  P1  ,  P2  ,  P3  , SLSH , RCBR ,
    // +------+------+------+------+------+------+------/        \------+------+------+------+------+------+------+
                                ,      ,      ,       ,                    , RAI0 ,      ,
    //                   +------+------+------+------/              \------+------+------+------+
),
...
[_RAISE] = LAYOUT_KC(
    ...
    // +------+------+------+------+------+------+------+        +------+------+------+------+------+------+------+
          xx  , ACL0 , ACL1 , ACL2 ,  xx  , BTN2 , BTN3 ,           xx  , MPRV , VOLD , VOLU , MNXT , MUTE , MPLY ,
    // +------+------+------+------+------+------+------/        \------+------+------+------+------+------+------+
                                ,      ,      , BTN1  ,                    ,      ,      ,     
    //                   +------+------+------+------/              \------+------+------+------+
),
